...
Gem::Specification.new do |spec|
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/sufcboy/ruby_palindrome'
  spec.metadata['changelog_uri'] = 'https://github.com/sufcboy/ruby_palindrome/blob/main/CHANGELOG.md'
